...
@section('titulo')
    ...
    <ol class="breadcrumb" style="font-size: 14px; background: none">
        <li class="breadcrumb-item"><i class="fas fea-home"></i>&nbsp;<a href="/home">Inicio</a></li>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary" style="text-align: center; color: black">
                            <h4 class="card-title">Actualizar inscripción de {{ $preinscrito->nombres }}</h4>

                        </div>

                        <form action="{{ route('inscripcion.update', $user->id) }}" method="post" class="form-horizontal">

                            @csrf
                            @method('put')
                            <div class="modal-body">
                                <h5 class="mt-2 mb-2 mx-auto text-center">Registro de Pago
                                </h5>
                                <hr>
                                <div class="row">
                                    <div class="col">
                                        <input type="text" hidden name="userId" value="{{ $preinscrito->id }}">
                                        ...
                                        <input id="n_recibo" type="text" maxlength="12"
                                            ...
                                            name="n_recibo" value="{{ $user->n_recibo }}" required autocomplete="n_recibo"
                                            autofocus>
                                    ...
                                    <div class="col-lg">
                                        ...
                                        <input id="monto" type="number" min="10"
                                            ...
                                            name="monto" value="{{ $user->monto }}" required autocomplete="monto"
                                            autofocus>
